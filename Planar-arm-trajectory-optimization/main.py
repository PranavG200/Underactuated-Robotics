...
# click on the link to start meshcat

# Compute the end effector (the ball) position and velocity using symbolic variables as xdot, ydot J_q (pos) * qdot
...
tf = 3.0
distance = 15.0
x_traj, u_traj, prog, _, _ = find_throwing_trajectory(N, initial_state, final_configuration, distance, tf)ory optimization to find the optimal trajectory
...
#Visualize the optimal trajectory This will animate the optimal trajectory in the meshcat window (see above)
